...
class GigasecondTest < Minitest::Test
  ...
  def test_with_your_birthday
    result = Gigasecond.from(Time.utc(1976, 12, 8, 0, 0, 0))
    assert_equal Time.utc(2008, 8, 16, 1, 46, 40), result
  end

  def test_with_leylas_birthday
    result = Gigasecond.from(Time.utc(2003, 9, 29, 0, 0, 0))
    assert_equal Time.utc(2035, 06, 07, 01, 46, 40), result
  end
